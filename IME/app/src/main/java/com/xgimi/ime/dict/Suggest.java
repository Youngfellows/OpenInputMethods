...
public class Suggest implements Dictionary.WordCallback {
     ...
     * @param  view for retrieving the context for AutoText
     * @param  wordComposer the list of codes. Each list item contains an array of character codes
