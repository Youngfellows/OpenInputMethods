...
public class IMESwitch {
    ...
    public boolean handleKey(int keyCode) {
        ...
        switch (keyCode) {
            ...
            case IMEKeyboard.KEYCODE_SHIFT: { // 速成/字母大小写  切换
                if (this.currentKeyboard.isCapLock()) { // 字母大小写切换
            ...
            case IMEKeyboard.KEYCODE_MODE_CHANGE_CHAR: { // 中/En
                this.switchToCharKeyboard();
                result = true;
                break;
            }
            case IMEKeyboard.KEYCODE_MODE_CHANGE: { // 123 数字键盘
